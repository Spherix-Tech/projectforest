...
import EmailLoginComponent from "../../../src/components/auth-components/login/EmailLoginComponent";
  ...
  return (
    <div>
      <Head>
        ...
        <title>Email Login | Project Forest</title>
        <meta
          name="title"
          ...
          <div className="nav-hero-section-bg">
            ...
            <div className="section-spacing">
              <div className="flex justify-center items-center">
                <AuthCard component={<EmailLoginComponent />} />
              </div>
            </div>
