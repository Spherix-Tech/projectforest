      ...
      <table className="w-full">
        <thead className="">
          <tr className="flex flex-row items-center w-full">
            <th className=" w-[20%] attributes-header ">Property Value</th>
            <th className=" w-[16%] gap-2 attributes-header">Common</th>
            <th className="w-[18%] gap-2 attributes-header">Uncommon</th>
            <th className="w-[15%] gap-2 attributes-header">Rare</th>
            <th className="w-[15%] gap-2 attributes-header">Epic</th>
