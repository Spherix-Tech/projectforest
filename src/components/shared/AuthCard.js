...
function AuthCard({ component }) {
  return (
    <div className="flex justify-center items-center auth-card relative ">
      <div className="min-h-[350px] flex justify-center items-center w-[400px] h-[280px] xs:w-[450px] xs:h-[350px] md:w-[750px] md:h-[450px] lg:w-[900px] lg:h-[500px] 2xl:w-[1320px] 2xl:h-[620px] rounded-[1rem] xl:rounded-[2rem] custom-shadow sha">
        {/* Left side */}
