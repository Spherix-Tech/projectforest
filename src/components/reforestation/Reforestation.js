...
const Reforestation = () => {
  return (
    <div className=" text-white section-spacing panel bg-[#35215D]">
      <div className="flex flex-col section-title-spacing justify-start items-start">
        <div className="section-title text-white ">Reforestation</div>
        <div className="section-sub-title text-white ">Need of the Hour</div>
      </div>
        ...
        {DataArr.map((e, i) => {
          return (
            <div
              key={i}
              className={
                "flex flex-1 relative flex-col w-full sm:max-w-[650px] h-[15rem] lg:h-[20rem] xl:h-[22rem] 2xl:h-[28rem] 3xl:h-[32rem] gap-1 md:gap-2 lg:mb-0 mb-4 items-center bg-white bg-opacity-10 p-4 pb-6 md:p-8 lg:p-4 " +
            ...
            >
              ...
              <div className="text-white font-bold text-[15px] text-start pt-2 w-full md:text-[17px]">
                {e.headingText}
              </div>
              <div className="text-white w-full text-start font-light text-[13px] text-opacity-70">
                {e.text}
              </div>
              <a
